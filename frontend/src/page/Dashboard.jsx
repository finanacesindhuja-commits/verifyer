...
function Dashboard() {
  ...
  const fetchLoans = async (isAuto = false) => {
        ...
        <header className="mb-8 flex justify-between items-start">
          ...
          <div className="flex gap-4 items-center">
            ...
            <button 
              ...
              className={`p-3 text-indigo-600 hover:bg-indigo-50 rounded-2xl transition-all active:scale-90 ${isRefreshing ? 'animate-spin' : ''}`}
              title="Refresh Now"
            >
